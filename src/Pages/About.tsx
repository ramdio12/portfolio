...
const About = () => {
  return (
    <section
      id="about"
      className="w-full bg-neutral-300 text-center md:flex  justify-center pt-12 overflow-hidden">
      ...
      <div className="basis-1/2  flex flex-col py-4 ">
        <h2 className="text-6xl font-bold text-headingColor ">About Me</h2>
        <p className="text-lg md:px-4">
        ...
        <motion.div
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-col items-start mt-4">
              <h3 className="text-xl md:text-2xl font-semibold text-headingColor">
                Office Clerk
              </h3>
            ...
            <div className="flex flex-col items-start mt-4">
              ...
              <h4 className="font-medium">Fligno Software Philippines Inc.</h4>
