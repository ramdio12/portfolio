...
export const projects = [
    {
        ...
        "description":"This is a cloning website from a company. Made with several functional components with the help of react and typescript.",
        "note":"Some of the content(image) changed.",
